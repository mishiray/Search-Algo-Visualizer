...
public class VisNode extends Button implements Vertex {
    ...
    static int count = 0;
    private final SimpleObjectProperty<Vertex> parent = new SimpleObjectProperty<>(null);
    private final DoubleProperty score =  new SimpleDoubleProperty(Double.POSITIVE_INFINITY);
    private final DoubleProperty gScore =  new SimpleDoubleProperty(Double.POSITIVE_INFINITY);
    private final double hScore = 0;
    public ObservableList<Edge> edges = FXCollections.observableArrayList();
    private static final BooleanProperty showScores = new SimpleBooleanProperty(false);
    private static final BooleanProperty showScore = new SimpleBooleanProperty(false);
